...
-- But Lightdash's join-then-group approach means sparse combinations (e.g., a segment
...
-- using a window function, so it's always correct regardless of which dimensions are selected.
